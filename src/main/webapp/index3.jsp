...
.plane {
	...
	padding-top: 50px; margin-bottom; auto;
	color: black;
...
.HelloUser {
	...
	text-align: center;
	margin-left: -30%;
	font-family: Roboto; section { display : flex; /* or inline-flex */
	flex-direction: row;
	align-items: center;
	gap: 10px;
}
			...
			<nav class="navbar navbar-dark bg-dark">
				<div class="container-fluid">
					...
					<video autoplay playsinline style="pointer-events: none"
						width="120" height="40" autoplay="autoplay" loop="loop" muted>
					...
					<span class="loginandregister" style="margin-left: 70%">
						<button class="btn btn-outline-success me-2" id="custom"
							type="button" onclick="location.href='login.jsp'">
							Login</button>
						<button class="btn btn-sm btn-outline-secondary" id="custom"
